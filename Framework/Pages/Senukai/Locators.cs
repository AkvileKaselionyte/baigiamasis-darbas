namespace Framework.Pages.Senukai
{
    public class Locators
    {
        internal class FrequentlyAskedQuestionsSection
        {
            ...
            internal static string selectionFieldInDropdownList = "//*[@class='select2-results__options']/li[@data-select2-id='10']";
            internal static string sectionWhenWillIReceiveMyOrder = "//*[@class='faq-question__title']";
        }
        ...
        internal class SmartNet
        {
            ...
            internal static string outputSmartNetCardNumbers = "//*[@id='card_prefix']";
        }
        internal class Stores
        {
            ...
            internal static string citiesDropdownList = "//*[@class='select2-results__options']";
